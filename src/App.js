    ...
    <>
      ...
      <section className="max-w-3xl mx-auto pt-16" id="home">
        <div className="container mx-auto px-4 pt-10 pb-16 flex flex-col-reverse sm:flex-row items-center justify-between md:px-6 md:py-20">
          ...
          <div className="flex flex-1 flex-col md:self-center items-start mt-7 sm:mt-0 font-display">
            <p className="text-3xl md:text-4xl text-green">I'm </p>
            <p className="text-3xl md:text-4xl">Deepanwita Dey</p>
            <p className="text-white text-opacity-80 text-base lg:text-lg mt-3 md:mt-4">
              React native developer with 6 months of work experience
            </p>
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 mt-16 md:grid-cols-2 gap-6 md:gap-2">
            <img
              src="./pic.jpg"
              alt="pic"
            ...
            <div className="px-2 flex flex-col gap-2">
              <p className="text-white text-opacity-70">
                This is Deepanwita, a Front-End developer who love to explore
                new technologies & always try to enhance my skills through
                developing new projects.
              </p>
              <p className="text-white text-opacity-70">
                Currently, I’m working as a React Native Developer in Cogito
                Software Solutions Pvt. Ltd, Kolkata.
              </p>
              <p className="text-white text-opacity-70">
                When I’m not working, usually you can find me making coffee &
                watching some good series.
              </p>
              {/* <p className="text-white text-opacity-70"> */}
              {/* Outside of work, I am usually reading, gaming, or providing */}
              {/* guidance to juniors. */}
              {/* </p> */}
              <div className="mx-auto md:mx-0 mt-12 flex flex-row">
                <a href="/cv.pdf" download="Joshua CV">
                  <button className="btn btn-primary flex mr-4">
                    Resume
                    <DownloadIcon className="h-4 w-4 self-center ml-2 opacity-70" />
                  </button>
                </a>
      ...
      >
        <div className="flex-col">
          ...
          <div className="justify-center grid grid-cols-1 mt-2 md:grid-cols-2 gap-6 md:gap-10">
            <div className=" justify-center bg-dark flex flex-col px-4 pb-6">
              <div className="flex flex-wrap gap-3 mt-6">
                <span className="justify-center rounded-full text-white bg-green px-8 py-2 text-xs font-bold ">
                  Html
                </span>
                <span className="rounded-full text-white bg-green px-4 py-2 text-xs font-bold ">
                  CSS
                </span>
                <span className="rounded-full text-white bg-green px-4 py-2 text-xs font-bold ">
                  Javascript
            ...
            <div className="flex-1 w-full flex flex-col items-baseline justify-around h-1/2 px-6 pb-4 relative">
              <div className="flex flex-col justify-start items-baseline">
                ...
                <p className="text-xs mt-2 text-white text-opacity-80 ">
                  A Movie Finder App using Fetch Data from API
                </p>
              ...
              <a
                href="https://github.com/095ddey/movie-app.git"
